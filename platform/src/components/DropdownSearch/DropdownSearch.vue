...
const useClasses = makeClasses<IThemeProps>(() => ({
    ...
    top: ({ themeSettings, isFocus, isFilled }) => {
    ...
    dropdownItem: ({ themeSettings, isFocus, isFilled }) => {
    ...
    dropdownItemLeft: ({ themeSettings, isFocus, isFilled }) => {
        return [themeSettings?.dropdownItem, [
            'min-w-[24px] pr-2'
        ]];
    },
    dropdownItemSearch: ({ themeSettings, isFocus, isFilled }) => {
        return [themeSettings?.dropdownItemFieldValue, [
            'text-200 font-medium'
        ]];
    },
    dropdownItemIcon: ({ themeSettings, isFocus, isFilled }) => {
        return [themeSettings?.dropdownItemIcon, [
            'mr-4 flex-shrink-0 text-200'
        ]];
    },
    dropdownItemСoincidence: ({ themeSettings, isFocus, isFilled }) => {
        return [themeSettings?.dropdownItemСoincidence, [
            'text-400'
        ]];
    },
}));
