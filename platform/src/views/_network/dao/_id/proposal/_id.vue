...
<!--                            />-->
                ...
                <div class="max-w-[252px] w-full mx-4 mt-11 lg:max-w-none md:mt-8">
                    <div class="min-h-full flex flex-col lg:flex-row lg:-mt-4 lg:-mx-2">
                        ...
                        <div
                            v-if="proposalData?.totalVp"
                            class="flex mt-4 lg:px-2 lg:w-[30.5%] md:w-1/3 sm:hidden"
                        >
                            <div class="w-full px-3 py-4 border border-surface-300 rounded-[12px]">
                                <TextSeparator
                                    class="mb-4 pb-4 border-b border-surface-300 whitespace-nowrap"
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <div class="flex-grow">
                                            <div :style="`width: ${ proposalData?.forVp / proposalData?.totalVp * 100 || 0 }%`" class="h-[6px] rounded-[2px] bg-[#078549]"></div>
                                        </div>
                                    </div>
                                    <div class="flex items-center mb-2">
                                        <div class="w-[100px] text-sm">
                                        ...
                                        <div class="flex-grow">
                                            <div :style="`width: ${ proposalData?.againstVp / proposalData?.totalVp * 100 || 0 }%`" class="h-[6px] rounded-[2px] bg-[#DA0000]"></div>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-grow">
                                            <div :style="`width: ${ proposalData?.abstainVp / proposalData?.totalVp * 100 || 0 }%`" class="h-[6px] rounded-[2px] bg-gray-600"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="flex">
                <div
                    ...
                    class="mr-5 relative overflow-hidden z-[-2] flex-shrink-0 sm:mr-2"
                >
                    <div>
                ...
                <div class="flex-grow pt-1 sm:pt-0">
                    <template v-if="proposalData?.pipeline.length">
                        <p class="title-h4 text-500 mb-[38px] lg:mb-[34px] sm:mb-[30px]">
                            Pipeline
                        </p>
                        <div class="space-y-4">
                            <div
                                v-for="(item, index) in proposal.data?.pipeline"
                                :key="index"
                            ...
                            >
                                <div>
                                    <p
                                        ...
                                        :class="{
                                        'h-full': index ===  proposal.data?.pipeline.length - 1
                                    }"
                                    >
                                        {{ index + 1 }}
                                    </p>
                    ...
                    <div
                        v-if="!proposalData?.voted"
                        class="flex -mx-4 -mt-8 pt-[69px] relative after:absolute after:top-0 after:right-full after:h-full after:w-screen after:-scale-1 after:bg-white after:-z-1 md:-mx-2 sm:-mx-1"
                    >
                        <div class="w-[145px] px-4 mt-8 md:w-1/3 md:px-2 sm:px-1">
                            <BaseButton
                                class="uppercase w-full"
                                :size="isMobile.sm ? 'sm' : 'md'"
                                @click="vote(ProposalVoteType.For)"
                            >
                                For
                            </BaseButton>
                        </div>
                        <div class="w-[145px] px-4 mt-8 md:w-1/3 md:px-2 sm:px-1">
                            <BaseButton
                                class="uppercase w-full"
                                :size="isMobile.sm ? 'sm' : 'md'"
                                @click="vote(ProposalVoteType.Against)"
                            >
                                Against
                            </BaseButton>
                        </div>
                        <div class="w-[145px] px-4 mt-8 md:w-1/3 md:px-2 sm:px-1">
                            <BaseButton
                                ...
                                :size="isMobile.sm ? 'sm' : 'md'"
                                view="outlined"
                                @click="vote(ProposalVoteType.Abstain)"
                            >
                                Abstain
                            </BaseButton>
                        </div>
...
async function vote(voteType: ProposalVoteType) {
    ...
    if (!error) {
        ...
        proposal.value.data!.voted = true;
    } else {
        notify({
            title: 'Error',
