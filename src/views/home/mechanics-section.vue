<template>
    <div class="container">
        ...
        <div class="flex justify-between px-[54px] lg:flex-col lg:px-0 lg:space-y-[100px]">
            <div
                v-for="(item, index) in currentItems"
                :key="item.title"
                class="max-w-[273px] relative lg:max-w-[203px]"
                :class="item.class"
            >
                <div class="lg:hidden" :style="`margin-top: ${ index * 70 + (index && 4) }px`"></div>
                <div
                    data-aos="fade"
                    :data-aos-delay="250 * index"
                    data-aos-offset="150"
                >
                    <div class="w-[98px] h-[98px] bg-primary-500 shadow-[0_32px_44px_rgba(14,22,103,.12)] rounded-[10px] flex items-center justify-center mb-9 lg:w-[70px] lg:h-[70px] md:w-[52px] md:h-[52px] lg:mb-5">
                        <BaseIcon
                            class="lg:scale-[0.9] md:scale-[0.7]"
                            :name="item.icon.name"
                    ...
                    <div
                        ...
                        class="absolute -z-1"
                        :class="!index ? 'left-[126px] top-[40px] w-[222px] lg:top-[240px] lg:left-[-25px] lg:rotate-[30deg] lg:scale-[0.7] sm:top-[132px] sm:left-[-146px] sm:rotate-[81deg]': 'left-[110px] top-[-20px] w-[246px] lg:top-[120px] lg:left-[150px] lg:rotate-[55deg] lg:scale-[0.7] sm:left-[110px]'"
                    ...
                    <div class="text-xl text-primary-500 mb-4 font-bold lg:text-lg">
                        {{ item.title }}
                    </div>
                    <div class="text-base text-primary-400 lg:text-sm">
                        {{ item.text }}
                    </div>
                </div>
            </div>
...
const items = [
    [
        ...
        {
            class: 'lg:self-center sm:self-start',
            icon: {
                name: 'rocket',
                width: 44.5,
                height: 44
